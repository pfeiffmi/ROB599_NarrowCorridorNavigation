...
#ros2 launch robot_pkg _launch.py world_sdf_file:="gazebo_worlds/building_robot.sdf" bridge_name:=ros_gz_bridge config_file:=<path_to_your_YAML_file> use_composition:=True create_own_container:=True